...
-- Create email template for invoice/contract acceptance notifications
INSERT INTO public.email_templates (
  ...
  'invoice_accepted_notification',
  'Invoice #{{invoice_number}} has been accepted by {{client_name}}',
  ...
  'notification',
  'Email template sent to business owners when clients accept invoices or contracts',
  true
);

-- Create email template for contract acceptance notifications  
INSERT INTO public.email_templates (
  name,
  subject,
  body,
  ...
  'contract_accepted_notification',
  'Contract terms accepted by {{client_name}} for Invoice #{{invoice_number}}',
  '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  'notification',
  'Email template sent to business owners when clients accept contract terms',
  true
);
