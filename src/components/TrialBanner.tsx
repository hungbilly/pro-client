...
const TrialBanner: React.FC = () => {
  ...
  return <div className={`w-full ${urgencyClass} text-white py-2 px-4`}>
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button size="sm" variant="outline" onClick={() => navigate('/subscription')} className="text-white border-white hover:bg-white/20 h-7">
            Upgrade Now
          </Button>
          <Button size="sm" variant="ghost" className="text-white hover:bg-white/20 p-1 h-7 w-7" onClick={handleDismiss}>
            <X className="h-4 w-4" />
