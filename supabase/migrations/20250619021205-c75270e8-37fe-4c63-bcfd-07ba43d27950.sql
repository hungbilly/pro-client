...
-- Update email template for invoice acceptance notifications to fix encoding issues
...
-- Update email template for contract acceptance notifications to fix encoding issues  
UPDATE public.email_templates 
SET body = '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
